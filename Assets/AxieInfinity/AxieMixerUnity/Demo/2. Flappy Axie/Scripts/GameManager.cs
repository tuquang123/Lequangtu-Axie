...
namespace Game
{
    public class GameManager : MonoBehaviour
    {
        ...
        void Start()
        {
            //Instantiate(fx,_birdFigure.transform.position, Quaternion.identity);
            ...
            string axieId = id;
                //PlayerPrefs.GetString("selectingId", "322002");
            string genes ="0x2000000000000300008100e08308000000010010088081040001000010a043020000009008004106000100100860c40200010000084081060001001410a04406";
                //PlayerPrefs.GetString("selectingGenes", "0x2000000000000300008100e08308000000010010088081040001000010a043020000009008004106000100100860c40200010000084081060001001410a04406");
